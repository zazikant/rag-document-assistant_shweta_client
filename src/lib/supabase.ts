...
const SUPABASE_URL = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://unmilshdstcpbbgddbkh.supabase.co';
const SUPABASE_ANON_KEY = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'sb_publishable_umSOxOQ_jomU-by15oumqA_4wQN2W3U';
